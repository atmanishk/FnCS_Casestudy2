...
- **Total Automated Tests**: **111 Tests** (100% passing, 0 failures, 0 errors, 0 skipped)
- **Line Coverage**: **86.85%** (436 / 502 lines covered)
- **Instruction Coverage**: **82.78%** (1,735 / 2,096 instructions covered)
- **Branch Coverage**: **61.22%** (120 / 196 branches covered)
- **Quality Gate**: Hard gate enforced via `jacoco-maven-plugin:check` (minimum threshold: **80.00%**)
- **Build Status**: [![Build & Tests](https://img.shields.io/badge/Tests-111%20Passing-success.svg)]() [![JaCoCo Coverage](https://img.shields.io/badge/Line%20Coverage-86.85%25-brightgreen.svg)]()
...
| `warehouses.adapters.restapi` | **100.0%** (46/46) | **100.0%** (179/179) | **91.7%** (11/12) | Pass (>80%) |
...
| `fulfillment.domain` | **81.4%** (57/70) | **74.3%** (211/284) | **53.6%** (15/28) | Pass (>80%) |
...
| **Total Across Entire Application** | **86.85%** (436/502) | **82.78%** (1,735/2,096) | **61.22%** (120/196) | **PASSED (>80%)** |

---

## Validation Separation Metrics

Following senior engineering feedback, validation logic was completely extracted into dedicated, reusable, and isolated domain validator components:
...
- **Location**: `com.fulfilment.application.monolith.fulfillment.domain.FulfillmentValidator`
- **Responsibilities**:
...
- **Dedicated Test Suite**: [`FulfillmentValidatorTest.java`](../fcs-interview-code-assignment-main/java-assignment/src/test/java/com/fulfilment/application/monolith/fulfillment/domain/FulfillmentValidatorTest.java) — **17 isolated unit tests** verifying each rule independently.
...
| **Total Automated Tests** | **111** | **All 111 Passing (0 Failures, 0 Errors)** |
...
The interactive HTML report is located at:
- **Build Output**: `fcs-interview-code-assignment-main/java-assignment/target/jacoco-report/index.html`
- **Versioned Tracking Report**: [`docs/jacoco-report/index.html`](jacoco-report/index.html)
